...
VALUES ('Tomato Soup','If you like pizza, but you hate the toppings, the cheese, and the crust, you''ll love this!',12.99,'images/tomato-soup-7.jpg'),
...
('Pepperoni','Classic pizza with cheese and pepperoni. Baked with a traditional crust in our brick oven.',14.99,'images/sdfl.jpg'),
('Over the Rainbow','Taste the rainbow! One ingredient of each color: pepperoni, doritos, pineapple, olives, cheese, peppers and onion. Complimentary water served in a spray bottle to taste an actual rainbow.',19.99,'images/rainbowpizza.jpg'),
('Chinese Firedragon','Pepperoni, pineapple and banana peppers.',15.99,'images/firepizza.jpg'),
('Bad Date','Garlic, Onion and Pepperoni.',24.99,'images/baddate.jpg'),
('Another Little Pizza My Heart', 'Cheese Pizza. Personal size only.', 5.99,'images/tinypizza.jpg');
